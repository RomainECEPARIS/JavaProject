...
public class ThreadedConnectionHandler extends Thread
{
    ...
    private RecupData recup = new RecupData();
    ...
    /*  String currentDateTimeText = theDateService.getDateAndTime();
        ...
        this.send(numeroTemperature);
     */   
        
    	RecupData info = recup.getTempDate();
    	System.out.println("The temperature/date values are: ");
    	System.out.println("temp= " + info.get_temp());
    	System.out.println("" + info.get_time());
    	
    	System.out.println("\n");
    	this.send(info.get_temp_time());
